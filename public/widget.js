(function () {
  ...
  function initializeWidget(publicConfig) {
    ...
    window.addEventListener("message", function (event) {
      ...
      var energyBillFile = message.energyBillFile instanceof Blob ? message.energyBillFile : null;
      var requestPayload = Object.assign({}, payload, utmContext(), {
        formToken: token,
      ...
      multipartBody.append("payload", JSON.stringify(requestPayload));
      if (energyBillFile) {
        var energyBillName = typeof energyBillFile.name === "string"
          ? energyBillFile.name.slice(0, 160)
          : "conta-de-luz";
        multipartBody.append("energyBill", energyBillFile, energyBillName);
      }
