      ...
      <div className="mx-auto grid min-h-[calc(100vh-40px)] w-full max-w-[1380px] overflow-hidden rounded-[28px] border border-[#D6E0E8] bg-white shadow-[0_28px_80px_rgba(14,35,55,0.16)] lg:grid-cols-[46%_54%]">
        <section className="flex min-h-[760px] items-center bg-white px-7 py-8 sm:px-12 lg:px-16 xl:px-20">
          <div className="mx-auto w-full max-w-[470px]">
            <BrandLogo
              ...
              className="mb-9 h-auto w-[210px] max-w-full object-contain object-left"
            />
            ...
            <div className="mb-7">
              ...
              <p className="mt-3 max-w-[420px] text-[15px] leading-6 text-[#607386]">
                Comece a organizar clientes, propostas e projetos solares em um só lugar.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4" noValidate>
              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  <label htmlFor="register-name" className="mb-2 block text-sm font-bold text-[#183956]">
                    Nome completo
                  </label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      autoComplete="name"
                      className="h-[50px] w-full rounded-xl border border-[#CFD9E2] bg-white pl-12 pr-4 text-[14px] text-[#0E2337] outline-none transition focus:border-[#0076DD] focus:ring-4 focus:ring-[#64B0F3]/15"
                    />
                  </div>
                </div>

                <div>
                  <label htmlFor="register-company" className="mb-2 block text-sm font-bold text-[#183956]">
                    Empresa
                  </label>
                  <div className="relative">
              ...
              <div>
                <label htmlFor="register-email" className="mb-2 block text-sm font-bold text-[#183956]">
                  E-mail
                </label>
                <div className="relative">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  <label htmlFor="register-password" className="mb-2 block text-sm font-bold text-[#183956]">
                    Senha
                  </label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="h-[50px] w-full rounded-xl border border-[#CFD9E2] bg-white pl-12 pr-11 text-[14px] text-[#0E2337] outline-none transition focus:border-[#0076DD] focus:ring-4 focus:ring-[#64B0F3]/15"
                    />
                    <button
                      type="button"
                      onClick={() => setShowPassword((current) => !current)}
                      className="absolute right-2 top-1/2 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-lg text-[#718496] transition hover:bg-[#F1F5F8] hover:text-[#183956]"
                ...
                <div>
                  <label htmlFor="register-confirm-password" className="mb-2 block text-sm font-bold text-[#183956]">
                    Confirmar senha
                  </label>
                  <div className="relative">
                    <LockKeyhole className="pointer-events-none absolute left-4 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-[#7D8E9E]" />
              ...
              <label className="flex cursor-pointer items-start gap-2.5 text-[12px] leading-5 text-[#53697B]">
                <input
                  ...
                  className="mt-0.5 h-4 w-4 shrink-0 accent-[#0076DD]"
                />
                <span>
                  Li e aceito os <button type="button" className="font-semibold text-[#0076DD]">Termos de Uso</button> e a <button type="button" className="font-semibold text-[#0076DD]">Política de Privacidade</button>.
                </span>
              </label>
            ...
            <div className="mt-5 text-center text-[13px] text-[#607386]">
              Já tem uma conta?{' '}
              <button
                type="button"
            ...
            <div className="mt-5 flex items-center justify-center gap-2 text-[12px] text-[#7A8C9C]">
              <ShieldCheck className="h-[17px] w-[17px] shrink-0 text-[#6E8B55]" />
        ...
        <section className="relative hidden min-h-[760px] overflow-hidden bg-[#0E2337] lg:block">
          ...
          <div className="absolute left-10 top-10 flex items-center gap-2 rounded-full border border-white/25 bg-[#0E2337]/45 px-4 py-2 text-xs font-semibold text-white backdrop-blur-md">
            ...
            Sua operação solar começa aqui
          </div>
          ...
          <div className="absolute bottom-0 left-0 right-0 p-10 xl:p-14">
            <div className="max-w-[560px] text-white">
              ...
              <h2 className="text-3xl font-extrabold leading-tight tracking-[-0.03em] xl:text-[38px]">
                Transforme oportunidades em projetos solares.
              </h2>
              <p className="mt-4 max-w-[500px] text-sm leading-6 text-white/80">
                Tenha clientes, propostas e gestão comercial organizados em uma única plataforma.
              </p>
            </div>
          </div>
        </section>
